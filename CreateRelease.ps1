...
# Main entry point
# ===========================
$projectFile = "FileDetails\FileDetails.csproj"
...
try {
    ...
    $output = Join-Path -Path $currentLocation -ChildPath "FileDetails\bin\"
    ...
    # Create the release
    & $dotnet publish "FileDetails.sln" -p:PublishProfile=FileDetails/Properties/PublishProfiles/FolderProfile
